...
namespace AnimalStore2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public RedirectToRouteResult RoleUser(string _Id)
        {
            ApplicationUser user =  UserManager.FindById(_Id);
        ...
        public RedirectToRouteResult DeleteRoleUser(string _Id)
        {
            ApplicationUser user = UserManager.FindById(_Id);
            UserManager.AddToRole(user.Id, "Admin");
            if (!(user.Email == "root@ukr.net")) { 
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("List", "Dogs");
                }
                AddErrors(result);
            }
